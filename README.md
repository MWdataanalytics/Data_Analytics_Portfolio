...
Presidential election data is explored, focusing mainly on state vote margin shifts between the 2012 and 2016 elections. Data is pulled from a variety of sources to visualize vote margin shifts for all 50 states and analyze the factors that contributed to these shifts in the 2016 election. 
